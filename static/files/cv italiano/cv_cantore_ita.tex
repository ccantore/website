...
\\
-\emph{Settembre 2009 - presente}: {\bf Vice direttore del centro di ricerca 'Centre for International Macroeconomic Studies' (CIMS) presso l'University of Surrey (Regno Unito).}\\
\\
\\
...
\\
\textbf{2016:} {University of Portsmouth; Workshop '\emph{Developments in Macroeconomics}' Universit\`{a} di Roma La Sapienza.} 
\\
...
%\end{center}
%\bigskip
%\text{*}La presente dichiarazione non necessita dell’autenticazione della firma se, ai sensi dell’art. 38, D.P.R. 445/00, è sottoscritta ed inviata insieme alla fotocopia, non autenticata di un documento di identità del dichiarante, all’ufficio competente. 
